...
const menuData = {
    ...
    jantinha: {
        title: "🍲 Jantinhas",
        items: [
            { name: "Jantinha ATEÇÃO! De Segunda a Sexta Feira", price: 12.00, img: "https://iili.io/fjUDoDQ.png", desc: "ATEÇÃO! De Segunda a Sexta Feira" }
        ]
    }
};
...
window.onload = () => {
    ...
    setTimeout(() => {
        ...
        addMsg("👋 *Olá! DêGusto Atendimento Online 24h* 😄<br>Estou aqui pra te ajudar com seu pedido!<br><br>💡 *Delivery GRÁTIS acima de R$25!*<br>Delivery a partir das 19h 📱 (34)99953-7698 - 💡 Para Fazer Pedido EX: quero x-tudo, quero x-bacon!");
        showSugg();
    }, 3000);
};
